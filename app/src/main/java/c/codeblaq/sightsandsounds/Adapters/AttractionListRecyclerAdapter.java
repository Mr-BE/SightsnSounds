...
import c.codeblaq.sightsandsounds.Category;
import c.codeblaq.sightsandsounds.CategoryCatalogActivity;
import c.codeblaq.sightsandsounds.DataManager;
    ...
    private void horizontalView(HorizontalViewHolder holder) {
        ...
        for (int i = 0; i < mCategories.size(); i++) {
            ...
            for (int j = 0; j < categoryLocations.size(); j++) {
                ...
                locations.add(new Location(attractionName, locationName, imageResource, atrractionDetails));
            }
        }
