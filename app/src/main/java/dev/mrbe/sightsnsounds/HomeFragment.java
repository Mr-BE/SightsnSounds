...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.whole_attraction_list);
        initDisplayContent();
    ...
    private void initDisplayContent() {
        ...
        AttractionListRecyclerAdapter adapter = new AttractionListRecyclerAdapter(this.getContext(), categories);
